...
void vector_swap(vector<int> &v1, vector<int> &v2,
                 ...
                 int start2, int end2)
{
    vector<int>  sliced1(v1.begin() + start1, v1.begin() + end1);
    vector<int>  sliced2(v2.begin() + start2, v2.begin() + end2);

    v1.erase(v1.begin() + start1, v1.begin() + end1);
    v2.erase(v2.begin() + start2, v2.begin() + end2);

    v1.insert(v1.begin() + start1, sliced2.begin(), sliced2.end());
    v2.insert(v2.begin() + start2, sliced1.begin(), sliced1.end());
}
